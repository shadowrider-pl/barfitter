...
import { BestsellerComponent } from 'app/entities/bestseller/bestseller.component';
...
describe('Component Tests', () => {
  describe('Bestseller Management Component', () => {
    let comp: BestsellerComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BestsellerComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bestsellers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
