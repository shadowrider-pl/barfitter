...
import { CashupComponent } from 'app/entities/cashup/cashup.component';
import { CashupService } from 'app/entities/cashup/cashup.service';
import { Cashup } from 'app/shared/model/cashup.model';

describe('Component Tests', () => {
  describe('Cashup Management Component', () => {
    let comp: CashupComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CashupComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.cashups[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
