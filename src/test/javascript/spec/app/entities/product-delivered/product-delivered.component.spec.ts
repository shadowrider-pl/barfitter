...
import { ProductDeliveredComponent } from 'app/entities/product-delivered/product-delivered.component';
...
describe('Component Tests', () => {
  describe('ProductDelivered Management Component', () => {
    let comp: ProductDeliveredComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProductDeliveredComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.productDelivereds[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
