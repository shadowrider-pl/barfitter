...
describe('Component Tests', () => {
  describe('Vat Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.vats[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
