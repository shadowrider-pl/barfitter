...
import { OrderClosedComponent } from 'app/entities/order-closed/order-closed.component';
...
describe('Component Tests', () => {
  describe('OrderClosed Management Component', () => {
    let comp: OrderClosedComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [OrderClosedComponent],
        providers: [
          {
        ...
        .overrideTemplate(OrderClosedComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.orderCloseds[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
