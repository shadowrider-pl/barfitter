...
import { ProductOnStockComponent } from 'app/entities/product-on-stock/product-on-stock.component';
...
describe('Component Tests', () => {
  describe('ProductOnStock Management Component', () => {
    let comp: ProductOnStockComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProductOnStockComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.productOnStocks[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
