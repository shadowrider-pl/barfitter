...
import { ProductSoldComponent } from 'app/entities/product-sold/product-sold.component';
...
describe('Component Tests', () => {
  describe('ProductSold Management Component', () => {
    let comp: ProductSoldComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProductSoldComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.productSolds[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
