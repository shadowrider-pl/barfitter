...
describe('Service Tests', () => {
  describe('ProductSold Service', () => {
    let injector: TestBed;
    let service: ProductSoldService;
    let httpMock: HttpTestingController;
    let elemDefault: IProductSold;
    let expectedResult;
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(ProductSoldService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new ProductSold(
        0,
        currentDate,
        currentDate,
        currentDate,
    ...
    describe('Service methods', () => {
      ...
      it('should create a ProductSold', () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            orderedTime: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should update a ProductSold', () => {
        const returnedFromService = Object.assign(
          {
            orderedTime: currentDate.format(DATE_TIME_FORMAT),
            acceptedTime: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should return a list of ProductSold', () => {
        const returnedFromService = Object.assign(
          {
            orderedTime: currentDate.format(DATE_TIME_FORMAT),
            acceptedTime: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should delete a ProductSold', () => {
