...
export class NewOrderService {
  private resourceUrl = SERVER_API_URL + 'api/order-whith-products';
...
//
// import { OrderOpened } from './new-order.model';
...
//    }
//
//    search(req?: any): Observable<HttpResponse<OrderOpened[]>> {
//        const options = createRequestOption(req);
//        return this.http.get<OrderOpened[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
//            .map((res: HttpResponse<OrderOpened[]>) => this.convertArrayResponse(res));
//    }
//
