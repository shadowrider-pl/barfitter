...
export class NewDayService {
  private resourceUrl = SERVER_API_URL + 'api/new-day';
...
//
//    create(cashup: Cashup): Observable<EntityResponseType> {
//        const copy = this.convert(cashup);
//        return this.http.post<Cashup>(this.resourceUrl, copy, { observe: 'response' })
...
//
//    query(req?: any): Observable<EntityResponseType> {
//        return this.http.get<Cashup>(`${this.resourceUrl}`, { observe: 'response'})
//            .map((res: EntityResponseType) => this.convertResponse(res));
//  }
//
