...
export class FavoriteComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.favoriteService
      ...
      .subscribe((res: HttpResponse<IFavorite[]>) => this.paginateFavorites(res.body, res.headers));
  }
  ...
  trackId(index: number, item: IFavorite) {
    return item.id;
  }
  ...
  protected paginateFavorites(data: IFavorite[], headers: HttpHeaders) {
