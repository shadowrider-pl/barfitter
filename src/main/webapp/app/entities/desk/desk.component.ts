...
export class DeskComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.deskService
      ...
      .subscribe((res: HttpResponse<IDesk[]>) => this.paginateDesks(res.body, res.headers));
  }
  ...
  trackId(index: number, item: IDesk) {
    return item.id;
  }
  ...
  protected paginateDesks(data: IDesk[], headers: HttpHeaders) {
